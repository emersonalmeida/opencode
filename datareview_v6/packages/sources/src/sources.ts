// Registry de fontes EM RUNTIME do nucleo v6; liga catalogo aos adaptadores de coleta real.
// V4 tinha keys na API; no v6 o nucleo expoe createSources para injecao testavel de keys, e sourcesFromEnv para ler do env.
// Ordem: SOURCES segue a prioridade sem-auth do catalogo.

import type { CollectOptions, CollectResponse } from '@v6/contracts';
import type { SourceDescriptor } from '@v6/contracts';
