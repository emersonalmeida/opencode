...
- Testes do sources: COREPACK_ENABLE_DOWNLOAD_PROMPT=0 pnpm --filter @v5/sources test
- Testes do dominio: COREPACK_ENABLE_DOWNLOAD_PROMPT=0 pnpm --filter @v5/domain test
